...
public class QueenMovesCalculator implements PieceMovesCalculator {
    ...
    public Collection<ChessMove> calculateQueenMoves(ChessBoard board, ChessPosition myPosition) {
        Collection<ChessMove> rookMoves = MovesCalculatorUtils.calculateRookLikeMoves(board, myPosition);
        Collection<ChessMove> bishopMoves = MovesCalculatorUtils.calculateBishopLikeMoves(board, myPosition);
